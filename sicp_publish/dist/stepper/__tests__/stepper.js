...
function getLastStepAsString(steps) {
    return (0, stepper_1.codify)(steps[steps.length - 1][0]).trim();
}
describe('Test codify works on non-circular abstract syntax graphs', () => {
    ...
    (1 + 2) * (3 + 4);
  `;
        const program = (0, parser_1.parse)(code, (0, context_1.mockContext)());
        expect((0, stepper_1.codify)(program)).toMatchInlineSnapshot(`
      "(1 + 2) * (3 + 4);
      "
    `);
    });
  ...
  `; // not valid stepper input, but can be generated by stepper
        const program = (0, parser_1.parse)(code, (0, context_1.mockContext)(types_1.Chapter.SOURCE_4));
        expect((0, stepper_1.codify)(program)).toMatchInlineSnapshot(`
      "[1, 2];
      "
    `);
...
describe('Test codify works on circular abstract syntax graphs', () => {
  ...
  `;
        const program = (0, parser_1.parse)(code, (0, context_1.mockContext)());
        const arrowFunctionExpression = program.body[0]
            .expression;
        const callExpression = arrowFunctionExpression.body;
...
test('Test basic substitution', () => {
  ...
  `;
    const program = (0, parser_1.parse)(code, (0, context_1.mockContext)());
    const steps = (0, stepper_1.getEvaluationSteps)(program, (0, context_1.mockContext)(), 1000);
    expect(steps.map(x => (0, stepper_1.codify)(x[0])).join('\n')).toMatchInlineSnapshot(`
    "(1 + 2) * (3 + 4);
...
test('Test binary operator error', () => {
    ...
    (1 + 2) * ('a' + 'string');
  `;
    const context = (0, context_1.mockContext)();
    const program = (0, parser_1.parse)(code, context);
    const steps = (0, stepper_1.getEvaluationSteps)(program, context, 1000);
    expect(steps.map(x => (0, stepper_1.codify)(x[0])).join('\n')).toMatchInlineSnapshot(`
    "(1 + 2) * ('a' + 'string');
...
test('Test two statement substitution', () => {
  ...
  `;
    const program = (0, parser_1.parse)(code, (0, context_1.mockContext)());
    const steps = (0, stepper_1.getEvaluationSteps)(program, (0, context_1.mockContext)(types_1.Chapter.SOURCE_4), 1000);
    expect(steps.map(x => (0, stepper_1.codify)(x[0])).join('\n')).toMatchInlineSnapshot(`
    "(1 + 2) * (3 + 4);
    3 * 5;
...
test('subsets', () => {
 ...
 subsets(list(1, 2, 3));
  `;
    const program = (0, parser_1.parse)(code, (0, context_1.mockContext)(types_1.Chapter.SOURCE_2));
    const steps = (0, stepper_1.getEvaluationSteps)(program, (0, context_1.mockContext)(types_1.Chapter.SOURCE_2), 1000);
    expect(steps.map(x => (0, stepper_1.codify)(x[0])).join('\n')).toMatchSnapshot();
});
// source 0

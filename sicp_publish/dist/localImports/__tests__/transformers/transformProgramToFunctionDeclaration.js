...
describe('transformImportedFile', () => {
    ...
    const assertASTsAreEquivalent = (actualCode, expectedCode) => {
        ...
        const actualFunctionDeclaration = (0, transformProgramToFunctionDeclaration_1.transformProgramToFunctionDeclaration)(actualProgram, currentFileName);
        ...
        expect((0, utils_1.stripLocationInfo)(actualFunctionDeclaration)).toEqual((0, utils_1.stripLocationInfo)(expectedFunctionDeclaration));
    };

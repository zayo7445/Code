...
class DirectedGraph {
    ...
    addEdge(sourceNode, destinationNode) {
        ...
        const neighbours = (_a = this.adjacencyList.get(sourceNode)) !== null && _a !== void 0 ? _a : new Set();
    ...
    calculateInDegrees() {
        ...
        for (const neighbours of this.adjacencyList.values()) {
            for (const neighbour of neighbours) {
                const inDegree = (_a = inDegrees.get(neighbour)) !== null && _a !== void 0 ? _a : 0;
    ...
    findCycle(inDegrees) {
        ...
        while (true) {
            ...
            if (nextNodeInCycle === null) {
                throw new Error(`None of the neighbours of node '${currentNode}' are part of the same cycle. This should never happen.`);
            }

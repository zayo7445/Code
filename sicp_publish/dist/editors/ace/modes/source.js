 ...
 */
function HighlightRulesSelector(id, variant = types_1.Variant.DEFAULT, external = 'NONE', externalLibraries = []) {
    // @ts-ignore
    function _SourceHighlightRules(acequire, exports, _module) {
        ...
        const chapter = variant === types_1.Variant.DEFAULT ? id.toString() : id.toString() + '_' + variant;
        ...
        const ChapterAndVariantForbiddenWordSelector = () => {
            ...
            if (variant !== types_1.Variant.TYPED) {

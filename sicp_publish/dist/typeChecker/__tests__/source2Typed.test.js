...
let context = (0, context_1.mockContext)(types_1.Chapter.SOURCE_2, types_1.Variant.TYPED);
beforeEach(() => {
    context = (0, context_1.mockContext)(types_1.Chapter.SOURCE_2, types_1.Variant.TYPED);
});
describe('null type', () => {
...
describe('pair', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 3: Type 'null' is not assignable to type 'Pair<number, null>'."`);
    });
    it('type alias with the same name cannot be declared', () => {
        const code = 'type Pair = string;';
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 1: Type alias 'Pair' has already been declared."`);
    });
});
describe('list', () => {
    it('handles type mismatches correctly', () => {
    ...
    it('type alias with the same name cannot be declared', () => {
        ...
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 1: Type alias 'List' has already been declared."`);
    });
});
describe('head', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 4: Expected 1 arguments, but got 2."`);
    });
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 7: Type 'string | number' is not assignable to type 'boolean'."`);
    });
...
describe('tail', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 7: Type 'List<string | number>' is not assignable to type 'List<boolean>'."`);
    });
});
...
//# sourceMappingURL=source2Typed.test.js.map
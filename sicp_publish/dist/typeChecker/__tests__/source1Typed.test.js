...
let context = (0, context_1.mockContext)(types_1.Chapter.SOURCE_1, types_1.Variant.TYPED);
beforeEach(() => {
    context = (0, context_1.mockContext)(types_1.Chapter.SOURCE_1, types_1.Variant.TYPED);
});
describe('basic types', () => {
    ...
    `;
        ...
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`""`);
    });
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 2: Type 'number' is not callable."`);
    });
...
describe('union types', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 6: Type 'boolean' is not assignable to type 'string | number'."`);
    });
...
describe('function types', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 3: Type '(boolean, boolean) => number | string' is not assignable to type '(number | string, number | string) => number | string'."`);
    });
...
describe('type aliases', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 2: Name x not declared."`);
    });
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 2: Type 'boolean' is not assignable to type 'string | number'."`);
    });
    it('should throw errors for undeclared types', () => {
        const code = `const x: x = 1;`;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 1: Type 'x' not declared."`);
    });
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 2: SyntaxError: Identifier 'x' has already been declared. (2:11)"`);
    });
...
describe('generic types', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 2: Type 'NotGeneric' is not generic."`);
    });
...
describe('unary operations', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 9: Type 'string' is not assignable to type 'boolean'."`);
    });
});
...
describe('conditional expressions', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 6: Type 'boolean | string' is not assignable to type 'number'."`);
    });
});
describe('if-else statements', () => {
    ...
    `;
        (0, parser_1.parse)(code, context);
        expect((0, __1.parseError)(context.errors)).toMatchInlineSnapshot(`"Line 13: Type 'string' is not assignable to type 'number'."`);
    });
});
...
//# sourceMappingURL=source1Typed.test.js.map